...
public class FoodSaxParser {
	private String nutritionFilePath = FoodSaxParser.class.getResource("").getPath()+"FoodNutritionInfo.xml";
	private String foodFilePath = FoodSaxParser.class.getResource("").getPath()+"foodInfo.xml";
