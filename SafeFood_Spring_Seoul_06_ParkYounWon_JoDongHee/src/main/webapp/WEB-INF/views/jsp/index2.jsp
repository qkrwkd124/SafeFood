...
<!-- 			<li><button class="snip1575" value="Submit">Submit</button></li> -->
	...
	<!--  <img id="aa" :src="img" style="position:fixed;border:1px solid black; width: 50px; height: 50px; z-index: 10;"/>-->
		...
		<%
			...
			for(Food t: list){
		%>
		 	<div class="sm-link sm-link_padding-all sm-link1 pdlist col-md-4" style="border-radius: 20px; border: solid rgba(255, 0, 0, 0.0) 3px; color: black;">
	             ...
	             <!--  <a href="detail_info.html"></a>-->
             		...
             		%>
             			<p>
				             ...
				             <button class="btn-secondary like-review" style="width: 100px;">
								<i class="fa fa-heart" aria-hidden="true"></i> 찜
							</button>
			             </p>
	             	<% }else{%>
          	   			<p>
          	   				<button class="btn-secondary like-review codeBtn" style="width: 100px;" value="<%=t.getCode()%>">
								 찜 하기
							</button>
							<!--  -->
			             </p>
